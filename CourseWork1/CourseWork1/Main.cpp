...
int main()
{
	...
	sf::Image icon;
	icon.loadFromFile("C:/Users/danil/source/repos/Danter54/OOP-2022/CourseWork1/assets/icon.png");
	window.setIcon(300,300, icon.getPixelsPtr());

	sf::Font font;
	font.loadFromFile("C:/Users/danil/source/repos/Danter54/OOP-2022/CourseWork1/assets/font.ttf");
